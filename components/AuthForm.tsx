    ...
    <section className='auth-form'>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        {type === 'sign-up' && (
         ...
         label="FirstName" placeholder="Enter your first name"/>
        ...
        <CustomInput control={form.control} name='state' 
         label="State" placeholder="Example: MP"/>
         
        <CustomInput control={form.control} name='postalCode' 
         label="Postal Code" placeholder="Example: 474006"/>
        </div>
